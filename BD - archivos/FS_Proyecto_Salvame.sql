...
--Creacion de Usuario adminSalvame: contiene todos los permisos de la base de datos
CREATE USER C##admin_salvame IDENTIFIED BY admin_salvame;
GRANT ALL PRIVILEGES TO C##admin_salvame;

CREATE USER C##sistema_salvame IDENTIFIED BY sistema_salvame;
GRANT ALL PRIVILEGES TO C##sistema_salvame;

CREATE TABLE C##sistema_salvamee.usuario_basico (
...
CREATE TABLE C##admin_salvame.perfil_usuario (
  idPerfilUsuario CHAR(10) PRIMARY KEY,
  rol VARCHAR2(30) NOT NULL,
  descripcion VARCHAR2(200)  
) TABLESPACE PROYECTOSALVAME;

--DROP TABLE  C##admin_salvame.perfil_usuario;
...
CREATE TABLE C##sistema_salvame.alerta (
  ...
  FOREIGN KEY (nroDoc) REFERENCES C##sistema_salvame.usuario_basico(nroDoc),
